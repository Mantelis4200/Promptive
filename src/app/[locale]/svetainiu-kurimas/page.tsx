...
export default function SvetainiuKurimasPage() {
    ...
    en: [
      {
        ...
        tagline: 'Deployed a 24/7 AI assistant that answers in seconds, captures leads, and hands off complex cases to a human — all without extra staff.',
        metric: '454',
        metricLabel: 'tickets in 6 weeks',
        logo: '/case-studies/rideon-logo.jpg',
        logoDark: true,
        logoText: 'R',
        category: 'chatbot' as const,
        results: [
          { metric: '454', label: 'unique tickets (6 wks)' },
          { metric: '<5s', label: 'first response' },
      ...
      },
      {
        ...
        tagline: 'AI chatbot performs live inventory checks, calculates quantities and prices on the fly, and captures leads — zero manual back-and-forth.',
        metric: '0',
        ...
        category: 'chatbot' as const,
        results: [
          { metric: 'Live', label: 'inventory via CSV' },
          { metric: '0', label: 'manual quotes' },
          { metric: 'Auto', label: 'lead capture' },
        ],
      },
      {
        company: 'Lentvario Mediena',
        ...
        results: [
          { metric: 'SEO', label: 'every page' },
          { metric: 'AI', label: 'visuals' },
      ...
      },
      {
        ...
        category: 'website' as const,
        results: [
          { metric: 'Fast', label: 'decision flow' },
          { metric: 'Clear', label: 'positioning' },
          { metric: 'SEO', label: 'optimised' },
        ],
      },
      {
        company: 'InvestAI',
        industry: 'Fintech / Personal Finance',
        tagline: 'Full-stack investment app: real-time portfolio tracking, AI analysis via Claude, VMI tax estimation, and news feed — all in Lithuanian.',
        metric: 'AI',
        metricLabel: 'portfolio analysis',
        logo: null,
        logoText: 'IA',
        category: 'webapp' as const,
        results: [
          { metric: 'AI', label: 'Claude analysis' },
          { metric: 'Live', label: 'Yahoo Finance prices' },
      ...
      },
      {
        ...
        results: [
          { metric: 'Clear', label: 'value comms' },
          { metric: '↑', label: 'flow to purchase' },
          { metric: 'Dual', label: 'brand + sales' },
        ],
      },
    ],
    lt: [
      {
        ...
        tagline: 'Įdiegtas 24/7 AI asistentas — atsako per sekundes, renka kontaktus ir perduoda sudėtingus atvejus žmogui be papildomo personalo.',
        metric: '454',
        metricLabel: 'užklausos per 6 savaites',
        logo: '/case-studies/rideon-logo.jpg',
        logoDark: true,
        logoText: 'R',
        category: 'chatbot' as const,
        results: [
          { metric: '454', label: 'unikalios užklausos' },
          { metric: '<5s', label: 'pirmas atsakymas' },
          { metric: '24/7', label: 'aptarnavimas' },
        ],
      },
      {
        company: 'Lentvario Mediena',
        industry: 'Gamyba / Medienos produktai',
        tagline: 'AI chatbotas tikrina atsargas realiuoju laiku, skaičiuoja kainas ir renka kontaktus — be rankinio darbo.',
        metric: '0',
        ...
        category: 'chatbot' as const,
        results: [
          { metric: 'Gyva', label: 'atsargų patikra' },
          { metric: '0', label: 'rankinių skaičiavimų' },
          { metric: 'Auto', label: 'kontaktų rinkimas' },
        ],
      },
      {
        company: 'Lentvario Mediena',
        ...
        category: 'website' as const,
        results: [
          { metric: 'SEO', label: 'kiekviename puslapyje' },
          { metric: 'AI', label: 'vizualai' },
          { metric: '↑', label: 'pirkti pasiruošę' },
        ],
      },
      {
        company: 'Cheats-pro',
        ...
        category: 'website' as const,
        results: [
          { metric: 'Greitas', label: 'sprendimų srautas' },
          { metric: 'Aiški', label: 'pozicija' },
          { metric: 'SEO', label: 'optimizuota' },
        ],
      },
      {
        company: 'InvestAI',
        industry: 'Fintech / Asmeninės finansai',
        tagline: 'Pilno stack\'o investicijų programa: portfelio valdymas, AI analizė (Claude), VMI mokesčių skaičiuoklė ir naujienų srautas — lietuviškai.',
        metric: 'AI',
        metricLabel: 'portfelio analizė',
        logo: null,
        logoText: 'IA',
        category: 'webapp' as const,
        results: [
          { metric: 'AI', label: 'Claude analizė' },
          { metric: 'Gyva', label: 'Yahoo Finance kainos' },
          { metric: 'Auto', label: 'VMI skaičiavimas' },
        ],
      },
      {
        company: 'Magnimoo',
        ...
        results: [
          ...
          { metric: 'Dual', label: 'prekės ženklas + pardavimai' },
        ],
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{c.process.title}</h2>
          </motion.div>

          {/* Horizontal Step Indicators */}
          <div className="flex justify-between items-center mb-6 relative">
            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-gray-200 -translate-y-1/2" />
            <div className="absolute top-1/2 left-0 h-0.5 bg-gradient-to-r from-purple-500 to-blue-500 -translate-y-1/2 transition-all duration-500" style={{ width: `${(activeStep / (c.process.steps.length - 1)) * 100}%` }} />
      ...
      <CaseStudyStrip cases={websiteCases} carousel />

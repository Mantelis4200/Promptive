    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <a href="/tinklarastis" className="text-purple-600 hover:text-purple-700">
            ← Back to blog
          </a>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
              <a href="/tinklarastis" className="hover:text-purple-600 transition-colors">{t('backToBlog')}</a>
              <span>→</span>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-3 leading-tight">
                        <a href={`/tinklarastis/${relatedPost.slug}`} className="hover:text-purple-600 transition-colors">
                          {relatedPost.title}
                        </a>
                      </h3>
